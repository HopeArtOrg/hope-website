...
export const platforms: Platform[] = [
  {
    ...
    arch: "x64",
    icon: "cib:windows",
    href: `${releaseBase}/Hope-RE_${LATEST_VERSION}_x64-setup.exe`,
  },
  {
    index: 2,
    name: "macOS",
    arch: "aarch64",
    icon: "cib:apple",
    href: `${releaseBase}/Hope-RE_${LATEST_VERSION}_aarch64.dmg`,
  },
  {
    index: 3,
    name: "Linux",
    arch: "amd64",
    icon: "cib:linux",
    href: `${releaseBase}/Hope-RE_${LATEST_VERSION}_amd64.AppImage`,
  },
  {
    index: 4,
    name: "Linux",
    arch: "aarch64",
    icon: "cib:linux",
    href: `${releaseBase}/Hope-RE_${LATEST_VERSION}_aarch64.AppImage`,
  },
];
...
export const navLinks: NavLink[] = [
  ...
  { key: "nav.blogs", path: "/blog", icon: "lucide:pen-line" },
];
...
export const HARUYU_LINKS: AuthorSocialLink[] = [
  {
    labelKey: "author.github",
    href: "https://github.com/quachdang122-jpg",
    icon: "lucide:github",
    color: "#a78bfa",
  },
  {
    labelKey: "author.vgen",
    href: "https://vgen.co/iceyDh",
    icon: "lucide:palette",
    color: "#f97316",
  },
  {
    labelKey: "author.facebook",
    href: "https://www.facebook.com/aksd021s",
    icon: "lucide:facebook",
    color: "#3b82f6",
  },
  {
    labelKey: "author.portfolio",
    href: "https://haruyasato.carrd.co",
    icon: "lucide:globe",
    color: "#22c55e",
  },
];
...
export const NOAH_LINKS: AuthorSocialLink[] = [
  ...
  {
    labelKey: "author.portfolio",
    href: "https://noah-pblog.vercel.app/en",
    icon: "lucide:globe",
    color: "#22c55e",
  },
];
